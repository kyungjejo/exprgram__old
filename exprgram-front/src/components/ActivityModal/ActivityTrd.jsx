            ...
            <Modal open={this.props.open}
                ...
                <Modal.Content>
                    ...
                    <Header as="h4">Target expression of the video: {this.props.targetExpression}</Header>
                        ...
                        <Form.Field>
                        <label>
                            Write {this.state.relationship_lst.length>0 ? 'or choose' : ''} the word that best describes the relationship between speakers.
                        ...
                        <Form.Field>
                        <label>
                            Write {this.state.location_lst.length>0 ? 'or choose' : ''} the word that best describes the location of the scene.
                        </label>
                        ...
                        <Form.Field>
                        <label>Write {this.state.emotion_lst.length>0 ? 'or choose' : ''} the word that best represents the emotion of the speaker.</label>
                        ...
                        <Form.Field>
                        <label>
                            Try to explain {this.state.intention_lst.length>0 ? 'or choose' : ''} the intention of the speaker.
                        </label>
